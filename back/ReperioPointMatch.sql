...
--
-- Host: localhost:3306
-- Generation Time: Apr 30, 2023 at 01:33 PM
...
CREATE TABLE `candidat` (
  ...
  `chemin_cv_candidat` varchar(10000) DEFAULT NULL,
  `ville_candidat` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `entreprise` (
  ...
  `domaine_entreprise` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fiche_poste` (
  ...
  `chemin_fiche_poste` varchar(10000) DEFAULT NULL,
  `ville_poste` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `fiche.poste`
  ADD CONSTRAINT `fk_poste_domaine` FOREIGN KEY (`id_domaine`) REFERENCES `domaine` (`id_domaine`),
...
ALTER TABLE `match`
  ...
  ADD CONSTRAINT `fk_match_poste` FOREIGN KEY (`id_poste`) REFERENCES `fiche.poste` (`id_poste`);

--
-- Constraints for table `relation`
--
ALTER TABLE `relation`
  ADD CONSTRAINT `fk_relation_candidat` FOREIGN KEY (`id_candidat`) REFERENCES `candidat` (`id.candidat`),
