...
--
-- Host: localhost:3306
-- Generation Time: Apr 28, 2023 at 09:32 AM
...
CREATE TABLE `candidat` (
  ...
  `chemin.cv.candidat` varchar(10000) DEFAULT NULL,
  `ville.candidat` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fiche.poste` (
  ...
  `chemin.fiche.poste` varchar(10000) DEFAULT NULL,
  `ville.poste` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `match`
  ADD KEY `id.match` (`id.candidat`,`id.entreprise`,`id.poste`),
